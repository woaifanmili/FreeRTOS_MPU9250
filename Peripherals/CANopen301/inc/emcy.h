...
typedef struct {
	UNS16 errCode; /*Flaxin 应急错误代码 301中文手册P62 表26 例如8130h */
	UNS8 errRegMask; /* 和相应错误对应的标志位，1001错误寄存器的值即是由多个它或起来的，注意它不是错误寄存器0x1001,但是0x1001的值会用它合成，真正的0x1001是d->error_register */
	UNS8 active;
} s_errors;
