 ...
 */
 /* Flaxin 301中文文档 P57 表22 */
//#define OD_SUCCESSFUL 	             0x00000000
//#define OD_READ_NOT_ALLOWED          0x06010001/* 试图读取只写对象 */
//#define OD_WRITE_NOT_ALLOWED         0x06010002/* 试图写入只读对象 */
//#define OD_NO_SUCH_OBJECT            0x06020000/* 对象不存在于对象字典 */
//#define OD_NOT_MAPPABLE              0x06040041/* 对象不能被映射进PDO */
//#define OD_LENGTH_DATA_INVALID       0x06070010/* 数据类型不匹配，服务长度参数不匹配 */
//#define OD_NO_SUCH_SUBINDEX 	     0x06090011/* 子索引不存在 */
//#define OD_VALUE_RANGE_EXCEEDED      0x06090030/* 无效的参数值（仅下载） */
//#define OD_VALUE_TOO_LOW             0x06090031/* 写入参数值太高（仅下载） */
//#define OD_VALUE_TOO_HIGH            0x06090032/* 写入参数值太低（仅下载） */
///* Others SDO abort codes 
// */
//#define SDOABT_TOGGLE_NOT_ALTERNED   0x05030000/* 翻转位未变化 */
//#define SDOABT_TIMED_OUT             0x05040000/* SDO协议超时 */
//#define SDOABT_OUT_OF_MEMORY         0x05040005 /* 内存不足Size data exceed SDO_MAX_LENGTH_TRANSFER */
//#define SDOABT_GENERAL_ERROR         0x08000000 /* 常见错误Error size of SDO message */
...
#define NMT_PTP_Start               0x03    // self def signal
#define NMT_PVT_RESTART             0x04    // self def signal
#define NMT_ENABLE_PRESET           0x06    // self def signal
#define NMT_ENABLE_PRESET2          0x0F    // self def signal
#define NMT_MOTION_STOP             0x0A    // self def signal
