...
/*Flaxin Canopen的DS301表44，对象字典的数据类型，中文版见P82 */
//#define boolean         0x01
//#define int8            0x02
//#define int16           0x03
//#define int32           0x04
 ...
 */
 /* Flaxin有点像DS301对象字典的条目说明，bAccessType对应访问权限，bDataType对应取值范围， pObject对应条目值的地址或指针*/
//typedef struct td_subindex
//{
//    UNS8                    bAccessType; /* Flaxin访问类型，可为RW，WO等值 */
//    UNS8                    bDataType; /* Defines of what datatype the entry is */ /* 数据类型，Canopen的DS301表44，对象字典的数据类型，中文版见P82 */
//    UNS32                   size;      /* The size (in Byte) of the variable */ /* 数据类型所占的字节数，例如可为sizeof (UNS32) */
//    void*                   pObject;   /* This is the pointer of the Variable */ /* 指向实际的子索引对象的指针，即该指针指向实际的子索引对象 */
//} subindex;
...
//{
//    subindex*   pSubindex;   /* Pointer to the subindex */ /*子索引结构体数组指针，指向子索引的指针 */
...
//                         *//* 子索引的数目 */ /* Flaxin 将0号子索引也计算在内，从TestMaster_objdict的定义就可以看出来 */
//    UNS16   index; /* Flaxin 主索引号，例如0x1001,0x1002等 */
//} indextable;

//typedef struct s_quick_index{
//	UNS16 SDO_SVR;       /* SDO服务器 */
//	UNS16 SDO_CLT;       /* SDO客户端 */
//	UNS16 PDO_RCV;       /* PDO接收 */
//	UNS16 PDO_RCV_MAP;   /* PDO接收映射 */
//	UNS16 PDO_TRS;       /* PDO发送 */
//	UNS16 PDO_TRS_MAP;   /* PDO发送映射 */
//}quick_index;


/*typedef struct struct_CO_Data CO_Data; */
//typedef UNS32 (*ODCallback_t)(CO_Data* d, const OD_OI_TypeDef *, UNS8 bSubindex);
